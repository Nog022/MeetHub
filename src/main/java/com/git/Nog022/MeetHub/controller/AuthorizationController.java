...
public class AuthorizationController {
    ...
    public ResponseEntity<LoginResponseDTO> login(@RequestBody @Validated AuthorizationDTO data) {
        try {
            ...
            logger.info("Dados recebidos: CPF: {}, Senha: {}", data.email(), data.password());
    ...
    public ResponseEntity<User> register(@RequestBody @Validated RegisterDTO registerDTO) {
        ...
        RegisterDTO dto = new RegisterDTO("João Silva","joao.silva@email.com","12345678901","123","Minha Empresa Ltda");

        logger.info("Registro mockado: {}", dto);
